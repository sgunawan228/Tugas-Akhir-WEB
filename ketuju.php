...
<table>
	<tr>
		<td>
		<h1><strong>ZenBook Flip S UX370UA</strong></h1>
		<p><b>ASUS ZenBook Flip S adalah salah satu laptop convertible tertipis dan teringan di dunia, 
		dirancang untuk mudah dibawa kemanapun. Dengan perpaduan teknologi yang canggih dan desain yang elegan serta kenyamanan dan 
		\fleksibilitas display 360° atau flippable. Laptop ini sangat stylish, keren untuk digenggam, maupun memudahkan presentasi. 
		Prosesor Intel® Core i7 memungkinkan Anda melalui tugas komputasi sehari-hari dengan mudah. 
		Ditambah dengan adanya stylus, kombinasi sempurna untuk Windows 10!</p>
		<h2 style="color:red;"><b>Rp 26.299.000 </h2>
		<h2 style="color:red;">(i7-8550U/16GB/512GB PCIe SSD/Win 10) </h2>
		</td>
		<td>
			<img src="img/DSC04688.png" alt="Laptop" style="width:500px;height:400px;">
		</td>
	</tr>
</table>
