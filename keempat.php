...
<table>
	<tr>
		<td>
		<h1><strong>ROG GX700VO</strong></h1>
		<h1 style="color:Red;"> <b>Unrivaled Cooling. Extreme Performance.</h1>
		<p>ROG GX700 adalah laptop gaming pertama yang dilengkapi dengan teknologi “water – cooling”. 
		Laptop gaming ini didesain untuk memberikan Anda akses potensi overclock yang sejajar dengan 
		kemampuan desktop gaming yang ekstrim. GX700 dilengkapi dengan Windows 10 Home, 
		prosessor Intel® Mobile K-SKU prosesor yang dapat di overclock, 
		Kartu Grafis NVIDIA® GeForce® GTX™ 980, dan RAM DDR4 memberikan Anda sebuah performa layaknya 
		sebuah desktop Anda di rumah, maupun performa yang maksimal untuk aktifitas Anda yang dinamis.</p>
		<h2 style="color:red;"><b>Rp 60.100.000</h2>
		</td>
		<td>
			<img src="img/01.png" alt="Laptop" style="width:400px;height:300px;">
		</td>
	</tr>
</table>
	<a href="spesifikasi/s4.php" class="btn btn-info" role="button">Spesifikasi</a>
