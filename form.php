...
<br />
<div class="container">
<form action="pr-form.php" method="POST">
  <div class="form-row">
  ...
  <div class="form-group">
    ...
    <input type="text" name="alamat" class="form-control"  placeholder="Alamat Langkap" required="required"> 
  </div>
  <div class="form-group">
    <label for="inputktp">No Identitas</label>
    <input type="text" name="no_identitas" class="form-control"  placeholder="No Identitas" required="required">
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" name="kode_pos" class="form-control"  placeholder="Kode Pos" required="required">
    </div>
  </div>
      </label>
    </div>
  </div>
  &nbsp &nbsp <button type="submit" class="btn btn-primary">Submit</button> &nbsp <button type="Reset" class="btn btn-primary">Hapus</button> 
