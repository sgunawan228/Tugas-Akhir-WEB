...
<table>
	<tr>
		<td>
		<h1><strong>ROG G551VW</strong></h1>
		<h1 style="color:Blue;"> <b>Notebook gaming performa hebat dengan grafis terbaik dan sistem pendingin yang tenang</h1>
		<p>ASUS Republic of Gamers (ROG) G Series menghadirkan kinerja terbaik berkat prosesor generasi ke-6 Intel® Core™ i7 dan grafis kelas gaming NVIDIA® GTX series. Anda akan takjub dengan kemampuan layar 4K Ultra-HD IPS-nya yang mampu menghadirkan sudut pandang seluas 178 derajat, dan dilengkapi ASUS SonicMaster dan penyempurna audio ROG AudioWizard. 
		Pengaturan suhu yang bekerja efisien serta tenang tidak akan mengganggu Anda saat bermain game.</p>
		<h2 style="color:red;"><b>Rp. 17.299.000</h2>
		</td>
		<td>
			<img src="img/00.png" alt="Laptop" style="width:500px;height:400px;">
		</td>
	</tr>
</table>
